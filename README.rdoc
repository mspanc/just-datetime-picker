...
* Added mongoid[http://www.mongoid.org] support (doabit[https://github.com/doabit])
* Added CSS to assets pipeline (doabit[https://github.com/doabit])
* Added zh-CN locale (doabit[https://github.com/doabit])
* Refactored gem building stuff (doabit[https://github.com/doabit])
