...
If rails >= 3.1, add this line to active_admin.css.scss

  *= require just_datetime

Otherwise, just append the following code to your CSS stylesheet:
...
* doabit[https://github.com/doabit]: Added mongoid[http://www.mongoid.org] support
* doabit[https://github.com/doabit]: Added CSS to assets pipeline
* doabit[https://github.com/doabit]: Added zh-CN locale

=== 0.0.2

* {Marcin Lewandowski}[https://github.com/saepia]: Fixed bug that caused date/time fields' validations to always fail on record update if such field was not modified.

=== 0.0.1

* {Marcin Lewandowski}[https://github.com/saepia]: Initial release
